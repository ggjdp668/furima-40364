...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録できるとき' do
      it 'nickname、email、passwordとpassword_confirmation、last_name、first_name、last_name_kana、first_name_kana、date_of_birthが存在すれば登録できる' do
    ...
    context '新規登録できないとき' do
      ...
      it 'passwordが全角を含むと登録できない' do
        @user.password = 'ｑq0000'
        @user.password_confirmation = 'ｑq0000'
        @user.valid?
        expect(@user.errors.full_messages).to include('Password is invalid')
      end
